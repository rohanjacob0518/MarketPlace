...
<head>
  <meta charset="UTF-8">
  <title>Marketplace - Orders Dashboard UI</title>
...
<div class="app-container">
  <div class="sidebar">
    ...
    <ul class="sidebar-list">
      ...
      <li class="sidebar-list-item">
        <a href="/Marketplace/PHP/ProductListSeller.php">
              ...
              while ($row = mysqli_fetch_assoc($sql)) {
                ...
                $orders[] = $row;
                    ...
                    foreach ($orders as $order) {
                      ...
                      ?>                                                       
                      <a href="OrderDetails.php?orderName=<?php echo urlencode($orderName); ?>" style="text-decoration:none">        
                      <div class="products-row">
                        
                          <div class="product-cell image">
                            <span><?php echo $orderName ?></span>
                          </div>
...
<script>
    function OrderSelect(oid) {

        var url = "/Marketplace/PHP/OrderDetails.php";
